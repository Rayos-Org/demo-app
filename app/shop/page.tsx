  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="mb-8 sm:mb-10">
        <p className="text-xs font-semibold text-blue-400 uppercase tracking-widest mb-2 sm:mb-3">Demo Catalog</p>
        <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3">Developer Gear</h1>
      ...
      {/* Info bar */}
      <div className="flex flex-wrap items-center gap-3 mb-6 sm:mb-8 p-3 sm:p-4 bg-blue-600/8 border border-blue-500/15 rounded-xl">
